...
export default function CourseStatus() {
    return (
        <div id="wd-course-status" style={{ width: "300px" }}>
            ...
            <button className="btn btn-lg wd-btn-secondary w-100 mt-1 text-start">
                <IoMdHome className="me-2 fs-5" /> New Announcement </button>
            <button className="btn btn-lg wd-btn-secondary w-100 mt-1 text-start">
                <LiaBullhornSolid className="me-2 fs-5" /> New Analytics </button>
            <button className="btn btn-lg wd-btn-secondary w-100 mt-1 text-start">
                <PiBellRingingFill className="me-2 fs-5" /> View Course Notifications </button>
        </div>
    );
}
